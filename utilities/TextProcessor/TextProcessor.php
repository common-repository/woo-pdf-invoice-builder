...
class TextProcessor
{
     ...
     */
    public static function GetInstance($dompdf=null){
        if(self::$_instance==null)
        {
            self::$_instance = new TextProcessor();
            self::$_instance->dompdf=$dompdf;
        }
    ...
    public function Process($text,$fontFamily='')
    {
/*
        if($fontFamily!='')
        {
            if(!isset($this->fontdata[$fontFamily])&&$this->dompdf!=null)
            {
